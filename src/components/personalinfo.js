...
import EDULOGO from '../images/edu2.png';
import COLL from '../images/college1.jpg';
import UNI from '../images/university.JPG';
            ...
            <div>
                ...
                <div id="about">
                    ...
                    <div className="card" style={{ width: '18rem', textAlign: 'center' }}>
                        <div style={{ alignContent: 'center', transition: '.5s' }} className="card-body card-hover">
                            <h5 className="card-title">About me</h5>
                            <p className="card-text">My name is Rafay Asad and I am a Full Stack Web Developer also an Educated and a motivated software engineering student and a quick learner, quick to ramp up with any existing development platform, and perform design, coding, debugging, and testing application and system software. Excellent interpersonal as well as communication skills and enjoys a high-pressure team environment.</p>
                        </div>
                    </div>
                </div><br />
                <div id="edu">
                    <h1><img id="edulogo" src={EDULOGO} alt="education" width="100px" />My Education</h1>
                </div>
                <div id="education">
                    <div className="container">
                        <div className="row">

                    <div className="card swing col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style={{width:'18rem'}}>
                        <img src={COLL} className="card-img-top" alt="..." />
                            <div className="card-body">
                                <h2 className="card-title">Jinnah Govt. College karachi</h2>
                                {/* <h5 className="card-text">Jinnah Govt. College karachi</h5> */}
                            </div>
                            <ul class="list-group list-group-flush">
                                <li className="list-group-item">Pre-engineering</li>
                                <li className="list-group-item">2016-2018</li>
                            </ul>
                    </div>

                    <div id="card2" className="card swing col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style={{width:'18rem'}}>
                        <img src={UNI} className="card-img-top" alt="..." />
                            <div className="card-body">
                                <h3 className="card-title">Sir Syed University of Technology and Engineering</h3>
                            </div>
                            <ul class="list-group list-group-flush">
                                <li className="list-group-item">Bachelor of Science in Software Engineering</li>
                                <li className="list-group-item">2019-2022</li>
                            </ul>
                    </div>
                        </div>
                    </div>
